"""
Django settings for summerjobportal project.
...
SECRET_KEY = 'django-insecure-!hs1yjgyo0do@b9)s%coa9m-iip1!(-qevw2xza_v)(1yf255q'
...
ROOT_URLCONF = 'summerjobportal.urls'
...
WSGI_APPLICATION = 'summerjobportal.wsgi.application'
